  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8 flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">{t('navigation.workers.title')}</h1>
          <p className="text-gray-500 mt-1">{t('navigation.workers.subtitle')}</p>
        </div>
